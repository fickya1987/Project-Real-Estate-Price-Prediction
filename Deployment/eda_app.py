...
def run_eda_app():
	...
	if submenu == "Descriptive":
		img1 = Image.open("Deployment\IMG\Real_Estate.jpg")
		st.image(img1)
		...
		with st.expander("Price Range Distribution"):
			img2 = Image.open("Deployment\IMG\Price_Range_Distribution.png")
			st.image(img2)

		with st.expander("Price with respect to Floor"):
			img3 = Image.open("Deployment\IMG\Property_Floor_Numbers_Bar.png")
			st.image(img3)
		
		with st.expander("Price with respect to Bedroom and Bathroom"):
			img4 = Image.open("Deployment\IMG\BednBath_Price_Bar.png")
			st.image(img4)

		with st.expander("Price with respect to Property Age"):
			img5 = Image.open("Deployment\IMG\Price_Age_Distribution.png")
			st.image(img5)

		with st.expander("Price with respect to SqFt Area"):
			img6 = Image.open("Deployment\IMG\SqFt_Area_Price_Scatter.png")
			st.image(img6)

		with st.expander("Central Mumbai Property Price"):
			img7 = Image.open("Deployment\IMG\Central Mumbai.png")
			st.image(img7)

		with st.expander("South Mumbai Property Price"):
			img8 = Image.open("Deployment\IMG\South Mumbai.png")
			st.image(img8)

		with st.expander("Thane Property Price"):
			img9 = Image.open("Deployment\IMG\Thane.png")
			st.image(img9)
